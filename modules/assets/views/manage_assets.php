...
<script>
  appValidateForm($('#assets-form'),{assets_name:'required',amount:'required',date_buy:'required',warranty_period:'required',unit_price:'required',depreciation:'required',assets_code: {
               required: true,
               remote: {
