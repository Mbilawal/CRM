...
<?php //echo "<pre>";  print_r($invoices_statuses); exit;?>
<style>
.custom_dev{
	    background: #fff;
        margin: 15px;
   ...
   <div class="panel_s mbot10">
      <div class="panel-body _buttons">
         ...
         <?php if(has_permission('invoices','','create')){ ?>
            <a href="<?php echo admin_url('invoices/invoice'); ?>?customer_id=<?php echo $clinetID; ?>" class="btn btn-info pull-left new new-invoice-list mright5"><?php echo _l('create_new_invoice'); ?></a>
         <?php } ?>&nbsp;&nbsp;
         ...
         <?php } ?>
         <a href="<?php echo admin_url('clients/client/'.$clinetID.'?group=statement'); ?>" style="margin-left:5px;" class="btn btn-warning pull-left menu-icon"><!--fa fa-area-chart-->Statement</a>
