            ...
            <div class="col-md-7">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <?php echo render_select('clientid',$merchants,array('userid','company'),'Merchant',(count($merchants) == 1) ? $merchants[0]['userid'] : '',array('required'=>'true')); ?>
                    </div>
                        <div class="form-group select-placeholder">
                            <!--<label for="clientid" class="control-label">Department / Departments</label>-->
                ...
                <div class="checkbox">
                    ...
                    <label for="<?php echo $setting; ?>">
                        <?php if($setting == 'hide_tasks_on_main_tasks_table'){ ?>
                            <?php echo str_replace("customer","department",_l('hide_tasks_on_main_tasks_table')); ?>
                        <?php } else{ ?>
                            <?php echo str_replace("customer","department",_l('project_allow_client_to',_l('project_setting_'.$setting))); ?>
                        <?php } ?>
                    </label>
                </div>
            <?php } else { ?>
