...
<?php //echo "<pre>";  print_r($franchise_driver); exit;?>
  ...
  <div class="content">
    <div class="row">
      ...
      <div class="testing col-md-12">
          ...
          <div class="panel-body">
            <div>
              <div class="tab-content">
                <h4 class="customer-profile-group-heading">Edit Franchise</h4>
                <div class="row">
                  <form action="https://crm.dryvarfoods.com/admin/franchise/edit_franchise_process" class="client-form" autocomplete="off" method="post" accept-charset="utf-8" novalidate="novalidate">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="contact_info">
                          <div class="row">
                            ...
                            <input type="text" id="first_name" name="first_name" class="form-control" autofocus="1" value="<?php echo $arr_general_customers['firstname']?>">
                              ...
                              <div class="form-group" app-field-wrapper="dryvarfoods_id">
                                <label for="last_name" class="control-label">Select Driver</label>
                                 <select class="js-example-data-ajax form-control select_filters" multiple data-live-search="true" name="driver_select[]"  id="driver_select" required="true">
                              <?php 
							  
							  $driveArr =  explode(",",$franchise_driver);
							  if(count($arr_drivers)>0){
									foreach($arr_drivers as $val){?>
                              <option value="<?php echo $val['driver_id'];?>" <?php echo (in_array($val['driver_id'],  $driveArr)) ? "selected" : "";?>><?php echo $val['firstname'];?></option>
                              <?php } } ?>
                            </select>
                              </div>
                              ...
                              <input type="hidden" name="staffid" id="staffid" value="<?php echo $arr_general_customers['staffid']?>" />
                            ...
                            <div class="col-md-6">
                              <div class="form-group" app-field-wrapper="address">
                                ...
                                <textarea id="address" name="address" class="form-control" rows="4"><?php echo $arr_general_customers['current_address']?></textarea>
                              </div>
                              <div class="form-group" app-field-wrapper="city">
                                <label for="city" class="control-label">City</label>
                                <input type="text" id="city" name="city" class="form-control" value="<?php echo $arr_general_customers['home_town']?>">
                              </div>
                              
                              <div class="form-group" app-field-wrapper="zip">
                                <label for="zip" class="control-label">Zip Code</label>
                                <input type="text" id="zip" name="zip" class="form-control" value="<?php echo $arr_general_customers['Personal_tax_code']?>">
                              </div>
        ...
        <button class="btn btn-info save-and-add-contact customer-form-submiter"> Update Franchise </button>
      </div>
