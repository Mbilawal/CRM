<?php defined('BASEPATH') or exit('No direct script access allowed');
 ...
 /* $drivers_idss  =  array($drivers_ids);	
  echo "<pre>";  print_r($drivers_idss); exit;
*/
 ?>
<?php init_head(); ?>
  ...
  <div class="content">
    <div class="row">
      ...
      <div class="testing col-md-12">
          ...
          <div class="panel-body">
            <div>
              <div class="tab-content">
                <h4 class="customer-profile-group-heading">Add New Franchise</h4>
                <div class="row">
                  <form action="https://crm.dryvarfoods.com/admin/franchise/add_franchise_process" class="client-form" autocomplete="off" method="post" accept-charset="utf-8" novalidate="novalidate">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="form-group" app-field-wrapper="company">
                                ...
                                <input type="text" id="first_name" name="first_name" class="form-control" autofocus="1" value="">
                              </div>
                              <div class="form-group" app-field-wrapper="dryvarfoods_id">
                                <label for="last_name" class="control-label">Last Name</label>
                                <input type="text" id="last_name" name="last_name" class="form-control" autofocus="1" value="">
                              </div>
                              ...
                              <?php if(count($arr_drivers)>0){
									foreach($arr_drivers as $val){
								     $drivers_idss  =  $drivers_ids;	
									 
									 
							   ?>
                                    
                                    <?php if (!in_array($val['driver_id'], $drivers_idss)){?>
                              ...
                              <div class="form-group" app-field-wrapper="commission">
                                ...
                                <input type="text" id="email" name="email" class="form-control" autofocus="1" value="">
                              </div>
        ...
        <button class="btn btn-info save-and-add-contact customer-form-submiter"> Save and create franchise </button>
      </div>
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  ...
                                  <div class="form-group" app-field-wrapper="billing_street">
                                    ...
                                    <textarea id="billing_street" name="billing_street" class="form-control" rows="4"></textarea>
                                  </div>
