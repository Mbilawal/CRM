        ...
        <div class="panel_s">
          <div class="panel-body">
             ...
             <div class="clearfix"></div>
              ...
              <div class="col-md-12 col-xs-12 bold p_style" style=""><h3> Filter Manual Orders    <div  class="pull-right" style="float:right"><small class="primary" style="color:darkgreen">Showing 25 of <span id="record_count"  ><?php echo $total_count?></span></small></div></h3> </div>
              <div class="clearfix"></div>
              <hr class="hr_style">
              <div class="row">
              ...
              <div class="row">
                <div class="col-md-12 col-xs-12" style="">
                  ...
                  <div class=" col-md-3 col-xs-6">
                    ...
                    <select class="js-example-data-ajax form-control select_filters1" id="clients_select">
              ...
              <tbody id="order_list">
                <?php foreach ($orders as $key => $value) { ?>
                  <tr role="row">
                    ...
                    <td><?php echo $value['restaurant_commision_fee']; ?></td>
...
$(document).ready(function(e) {
  ...
  $("body").on("click", ".order_filter_pagination li a", function(event){
    ...
    if($(this).data("ci-pagination-page")){
      ...
      $.ajax({
          url: "<?php echo admin_url(); ?>orders/manual_order_revenue_ajax/"+page,
          type: "POST",
