        ...
        <div class="panel_s">
          <div class="panel-body">
             ...
             <div class="clearfix"></div>
              ...
              <div class="col-md-12">
                <h3 class="padding-5 p_style">Dryvarfoods Revenue Report  <span class="pull-right">
				</span>
				</h3>
			  </div>
              <hr class="hr_style" />
              <div class="col-md-12 col-xs-12 bold p_style" style=""><h3> Filter Revenue Report</h3></div>
              <div class="clearfix"></div>
              <hr class="hr_style">
			  <form id="revenueReportFilter" autocomplete="off" method="post" action="<?php echo AURL;?>reports/export_revenue_csv">
...
//Date range as a button
    $('#daterange-btn').daterangepicker(
      ...
      function (start, end, text_label="") {
        ...
        $.ajax({
                type:'POST',
                url:'<?php echo base_url();?>admin/reports/revenue_report_ajax',
