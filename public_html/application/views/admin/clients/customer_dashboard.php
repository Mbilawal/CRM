              ...
              <div class="col-md-12">
                <h3 class="padding-5" style="color: #03a9f4;">
                  ...
                  <span style="float: right;width: 30%">
                    ...
                    <form id="myForm" class="col-md-12 col-xs-12" style="float: right;width: 100%" action="<?php echo admin_url().'clients/customer_dashboard';?>" method="get" >
                      <div class=" col-md-12 col-xs-12">
                        <select class="js-example-data-ajax form-control city_name" name="city">
                          <option value="" >All Cities</option>
                          <?php foreach( $cities as $key => $value){ ?>

                            <option <?php if(isset($_GET["city"]) && $_GET["city"]==$value['city_name']){ ?> selected <?php } ?> value="<?php echo $value['city_name'];?>" ><?php echo $value['city_name'];?></option>
                 ...
                 <!--<div class="quick-stats-invoices col-xs-12 col-md-2 col-sm-2">
                  ...
                  <div class="top_stats_wrapper ">
                     ...
                     <p class="text-uppercase mtop5 "><i class="hidden-sm glyphicon glyphicon-edit"></i> Average Order</p>
                        <span class="pull-right bold no-mtop hrm-fontsize24"><?php echo $stats['average_amount']; ?> R</span>
                     </a>
                     <div class="clearfix"></div>
                     <div class="progress no-margin progress-bar-mini">
                  ...
                  <div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-2">
                    <div class="top_stats_wrapper ">
                       ...
                       <p class="text-uppercase mtop5 "><i class="hidden-sm glyphicon glyphicon-edit"></i> Total Revenue</p>
                          <span class="pull-right bold no-mtop hrm-fontsize24"><?php echo $stats['total_amount']; ?> R</span>
                       </a>
                       <div class="clearfix"></div>
                       <div class="progress no-margin progress-bar-mini">
                  ...
                  <div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-2">
                    <div class="top_stats_wrapper ">
                       ...
                       <p class="text-uppercase mtop5"><i class="hidden-sm glyphicon glyphicon-edit"></i> Completed Revenue</p>
                          <span class="pull-right bold no-mtop hrm-fontsize24"><?php echo $stats['total_amount_c']; ?> R</span>
                       </a>
                       <div class="clearfix"></div>
                       <div class="progress no-margin progress-bar-mini">
                          <div class="progress-bar progress-bar-success no-percent-text not-dynamic hrm-fullwidth" role="progressbar" aria-valuenow="13" aria-valuemin="<?php echo $stats['total_orders']; ?>" aria-valuemax="13" data-percent="100%">
                  ...
                  <div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-2">
                    <div class="top_stats_wrapper ">
                       ...
                       <p class="text-uppercase mtop5 "><i class="hidden-sm glyphicon glyphicon-remove"></i> Declined Revenue</p>
                          <span class="pull-right bold no-mtop hrm-fontsize24"><?php echo $stats['total_amount_d']; ?> R</span>
                       </a>
                       <div class="clearfix"></div>
                       <div class="progress no-margin progress-bar-mini">
                  ...
                  <div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-2">
                    <div class="top_stats_wrapper ">
                       ...
                       <p class="text-uppercase mtop5 "><i class="hidden-sm glyphicon glyphicon-edit"></i> Pending Revenue</p>
                          <span class="pull-right bold no-mtop hrm-fontsize24"><?php echo $stats['total_amount_p']; ?> R</span>
                       </a>
                       <div class="clearfix"></div>
                       <div class="progress no-margin progress-bar-mini">
              ...
              <div class="panel_s contracts-expiring">
                <div class="panel-body padding-10" style="    min-height: 352px;">
                  ...
                  <div class="text-center padding-5">
				    <div class="col-md-6">
                      <div class="panel_s contracts-expiring">
                        <div class="panel-body padding-10" style="min-height: 352px;max-height: 352px;">
                            
                            <h3 class="padding-5 text-danger">Overall Customers Ordering Stats</h3>
                            <hr class="hr-panel-heading-dashboard">
                            <div class="text-center padding-5">
                                <table class="table table-dashboard-two">
                                  <tbody>
                                      <tr>
                                        <td class="wd-lg-25p pull-left">First Time Ordering</td>
                                        <td class="wd-lg-25p "><span class="label label-success"><?php echo count($first_purchased);?></span></td>
                                      </tr>
									  <tr>
                                        <td class="wd-lg-25p pull-left">Not Purchased more than 10 days</td>
                                        <td class="wd-lg-25p "><span class="label label-info"><?php echo count($purchased_10);?></span></td>
                                      </tr>
									  <tr>
                                        <td class="wd-lg-25p pull-left">New Signups in last 10 days</td>
                                        <td class="wd-lg-25p "><span class="label label-warning"><?php echo count($new_signups);?></span></td>
                                      </tr>
                    ...
                    <div class="col-md-6">
                      <div class="panel_s contracts-expiring">
                        <div class="panel-body padding-10" style="min-height: 352px;max-height: 352px;">
                            ...
                            <h3 class="padding-5 text-info">Overall Never Purchased Stats</h3>
                            <hr class="hr-panel-heading-dashboard">
                            <div class="text-center padding-5">
                                <table class="table table-dashboard-two">
                                  ...
                                  <tbody>
                                  <tr>
                                        <td class="wd-lg-25p pull-left">Never Purchased</td>
                                        <td class="wd-lg-25p "><span class="label label-success"><?php echo count($never_purchased);?></span></td>
                                      </tr>
									  <tr>
                                        <td class="wd-lg-25p pull-left">Signed Up 7 days ago</td>
                                        <td class="wd-lg-25p "><span class="label label-info"><?php echo count($never_purchased_7_days);?></span></td>
                                      </tr>
									  <tr>
                                        <td class="wd-lg-25p pull-left">Signed Up 14 days ago</td>
                                        <td class="wd-lg-25p "><span class="label label-warning"><?php echo count($never_purchased_14_days);?></span></td>
                                      </tr>
									   <tr>
                                        <td class="wd-lg-25p pull-left">Signed Up 30 days ago</td>
                                        <td class="wd-lg-25p "><span class="label label-danger"><?php echo count($never_purchased_30_days);?></span></td>
                                      </tr>
									   <tr>
                                        <td class="wd-lg-25p pull-left">Signed Up 60 days ago</td>
                                        <td class="wd-lg-25p "><span class="label label-success"><?php echo count($never_purchased_60_days);?></span></td>
                                      </tr>
									   <tr>
                                        <td class="wd-lg-25p pull-left">Signed Up 90 days ago</td>
                                        <td class="wd-lg-25p "><span class="label label-info"><?php echo count($never_purchased_90_days);?></span></td>
                                      </tr>
                                  ...
                                  <tbody>
                                    ...
                                    <?php foreach($first_purchased as $key => $value){ ?>
                                      ...
                                      <tr >
                                        ...
                                        <td class="wd-lg-25p pull-left"><a href="<?php echo admin_url()?>clients/customer_details/<?php echo $value['dryvarfoods_id'] ?>" target="_blank" ><?php echo ucfirst($value['customer_name'])?> </a></td>
          ...
          series: {
              ...
              point: {
                events: {
                    click: function(event){
                      var id = event.point.id;
                      var win = window.open("<?php echo admin_url()?>clients/customer_details/"+id, '_blank');
                      if (win) {
                          win.focus();
                      } else {
                          alert('Please allow popups for this website');
