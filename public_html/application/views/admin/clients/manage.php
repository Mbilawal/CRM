...
<div id="wrapper">
            ...
            <div class="panel_s">
               <div class="panel-body">
                  ...
                  <div class="row mbot15">
                     <div class="col-md-12" >
                        <h4 class="no-margin" style="color: #03a9f4;">Merchant Summary</h4>
                     </div>
                     <br />
                  ...
                  <div class="top_stats_wrapper ">
                     <a class="text-dafault mbot15">
                     <p class="text-uppercase mtop5 "><i class="hidden-sm glyphicon glyphicon-user"></i> Total Merchants            </p>
                     ...
                     <div class="progress no-margin progress-bar-mini">
                        <div class="progress-bar progress-bar-dafault no-percent-text not-dynamic hrm-fullwidth" role="progressbar" aria-valuenow="13" aria-valuemin="<?php echo total_rows(db_prefix().'clients',($where_summary != '' ? substr($where_summary,5) : '')); ?>" aria-valuemax="13" data-percent="100%">
                        </div>
                     </div>
                  </div>
                </div>
                  ...
                  <div class="top_stats_wrapper ">
                     ...
                     <p class="text-uppercase mtop5 "><i class="hidden-sm glyphicon glyphicon-user"></i> Active Merchants            </p>
                        <span class="pull-right bold no-mtop hrm-fontsize24"><?php echo total_rows(db_prefix().'clients','active=1'.$where_summary); ?></span>
                     </a>
                     <div class="clearfix"></div>
                     <div class="progress no-margin progress-bar-mini">
                        <div class="progress-bar progress-bar-success no-percent-text not-dynamic hrm-fullwidth" role="progressbar" aria-valuenow="13" aria-valuemin="<?php echo total_rows(db_prefix().'clients',($where_summary != '' ? substr($where_summary,5) : '')); ?>" aria-valuemax="13" data-percent="100%">
                        </div>
                     </div>
                  </div>
                </div>
                ...
                <div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-3">
                  <div class="top_stats_wrapper ">
                     ...
                     <p class="text-uppercase mtop5 "><i class="hidden-sm glyphicon glyphicon-user"></i> Inactive Merchants            </p>
                        <span class="pull-right bold no-mtop hrm-fontsize24"><?php echo total_rows(db_prefix().'clients','active=0'.$where_summary); ?></span>
                     </a>
                     <div class="clearfix"></div>
                     <div class="progress no-margin progress-bar-mini">
                        <div class="progress-bar progress-bar-warning no-percent-text not-dynamic hrm-fullwidth" role="progressbar" aria-valuenow="13" aria-valuemin="<?php echo total_rows(db_prefix().'clients',($where_summary != '' ? substr($where_summary,5) : '')); ?>" aria-valuemax="13" data-percent="100%">
                        </div>
                     </div>
                  </div>
                </div>
 ...
 <div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-3">
                  <div class="top_stats_wrapper ">
                     ...
                     <p class="text-uppercase mtop5 "><i class="hidden-sm glyphicon glyphicon-user"></i> Contacts Logged In Today           </p>
                        <span class="pull-right bold no-mtop hrm-fontsize24">0</span>
                     </a>
                     <div class="clearfix"></div>
                     <div class="progress no-margin progress-bar-mini">
                     ...
                     <!--<div class="col-md-2 col-xs-6 border-right">
                        <h3 class="bold"><?php echo total_rows(db_prefix().'clients','active=1'.$where_summary); ?><?php //echo total_rows(db_prefix().'contacts','active=1'.$where_summary); ?></h3>
                  ...
                  <div class="checkbox">
                     ...
                     <label for="exclude_inactive"><?php echo _l('exclude_inactive'); ?> Merchants</label>
                  </div>
                     ...
                     $_table_data = array(
                      '<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="clients"><label></label></div>',
                       array(
                         ...
                         array(
                         'name'=>_l('Offline / Online'),
                         'th_attrs'=>array('class'=>'toggleable', 'id'=>'th-status')
                        ),
                        array(
                         'name'=>_l('Merchant Data Source'),
                         'th_attrs'=>array('class'=>'toggleable', 'id'=>'th-Client-Owner')
                        )/*,
                        array(
