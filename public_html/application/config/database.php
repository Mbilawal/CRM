...
$db['default'] = array_merge([
    ...
    'cache_on'     => false,
    'cachedir'     => '',
    'char_set'     => defined('APP_DB_CHARSET') ? 'utf8mb4' : 'utf8mb4',//'utf8', //APP_DB_CHARSET
    'dbcollat'     => defined('APP_DB_COLLATION') ? 'utf8mb4_unicode_ci' : 'utf8mb4_unicode_ci',//'utf8_general_ci', //APP_DB_COLLATION
    'swap_pre'     => '',
    'encrypt'      => $db_encrypt,
    'compress'     => false,
    'failover'     => [],
