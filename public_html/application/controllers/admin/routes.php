...
//For Drivers
$route['admin/drivers/(:num)'] = "admin/drivers/index/$1";

$route['admin/drivers/drivers_ajax/(:num)'] = "admin/drivers/drivers_ajax/$1";

$route['admin/drivers/detail/(:num)'] = "admin/drivers/detail/$1";

//For Manual Orders
$route['admin/orders/(:num)'] = "admin/orders/index/$1";

$route['admin/orders/drivers_ajax/(:num)'] = "admin/orders/orders_ajax/$1";
