			    ...
			    <div class="row">
					 <div class="col-md-6">
						  <div class="form-group open-ticket-subject-group">
							 <label for="department"><?php echo _l('coding'); ?></label>
					 ...
					 <div class="col-md-6">
					  ...
					  <div class="form-group open-ticket-subject-group">
							 <label for="department">What you would rate our communication?</label>
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group open-ticket-subject-group">
							 <label for="department">How do you rate our overall services?</label>
                     ...
                     <div class="col-md-6">
                        <div class="form-group open-ticket-subject-group">
							 <label for="department">Would you recommend us to others?</label>
					...
					<div class="form-group open-ticket-message-group">
						   <label for=""><?php echo _l('comments'); ?>:</label>
