...
class Clients extends AdminController
{
    ...
    {   
        ...
        $count_total_leads = $this->clients_model->get_orders_count($input_arr);
    ...
    {   
        ...
        $count_total_leads = $this->clients_model->get_orders_count($this->input->post());
    ...
    {   
        $data['stats'] = $this->clients_model->customer_dashboard_stats();
        $data['never_purchased'] = $this->clients_model->customer_never_purchased();
        $data['first_purchased'] = $this->clients_model->customer_first_purchased();
        $data['purchased_10'] = $this->clients_model->customer_not_purchased(10);
        $data['top_10_restaurants'] = $this->clients_model->top_10_restaurants();

        $data['new_signups'] = $this->clients_model->new_signups();

        $data['top_10_contacts'] = $this->clients_model->top_10_contacts();
    ...
    {   
        ...
        $never_purchased = $this->clients_model->customer_never_purchased($range);
