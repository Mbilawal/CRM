...
class Invoices extends AdminController   //
{
    ...
    public function list_invoices($id = '')
    {
		...
		$clinetID  = $invoices['clientid']; 
		$data['clinetID']    = $clinetID;
    ...
    public function table($clientid = '')
    {
        ...
        if($clientid == ""){
            ...
            // exit;
            // $client_arr = explode('#', $clientid);
            // echo $clientid = $client_arr[0];
            // exit;
        }
        ...
        if ($this->input->post()) {
            ...
            if ($id == '') {
                ...
                if ($invoice_id) {
                    ...
                    $redUrl = admin_url('invoices/list_invoices/' . $invoice_id);
                    
                    if (isset($invoice_data['save_and_download'])) {
                        $this->pdf($invoice_id);
                    }
	 ...
	 public function invoice_details($id = '')
    {
        ...
        $this->load->view('admin/invoices/invoice_details', $data);
    ...
    public function pdf2()
    {
        ...
        $invoice_number = $this->get_random_value();
        $invoice_number = '458';
        $invoice = array();
        ...
        $invoice = 
            array(
                ...
                'commission' => 0,
                'sent' => 1,
                'datesend' => '2021-01-04 00:00:00',
                'clientid' => 86,
                'deleted_customer_name' => '',
                'number' => '86000001',
                'prefix' => 'MER',
                'number_format' => 0,
                'datecreated' => '2021-01-04 00:00:00',
                'date' => '2021-01-04',
                'duedate' => '2021-01-04',
                'currency' => 1,
                'subtotal' => '2161.44',
                    ...
                    (
                        array
                            (
                                ...
                                'date' => '2020-12-28',
                                'sales_amount' => '138.5',
                                'commission_amount' => '124.65',
                                'invoice_id' => 458,
                                'commission_amount_2' => '13.85',
                            ),
                        ...
                        array
                            (
                                ...
                                'date' => '2020-12-28',
                                'sales_amount' => 116,
                                'commission_amount' => '104.4',
                                'invoice_id' => 458,
                                'commission_amount_2' => '11.6',
                            ),
                        ...
                        array
                            (
                                ...
                                'date' => '2020-12-28',
                                'sales_amount' => '92.4',
                                'commission_amount' => '83.16',
                                'invoice_id' => 458,
                                'commission_amount_2' => '9.24',
                            ),
                        ...
                        array
                            (
                                ...
                                'date' => '2020-12-29',
                                'sales_amount' => '264.4',
                                'commission_amount' => '237.96',
                                'invoice_id' => 458,
                                'commission_amount_2' => '26.44',
                            ),
                        ...
                        array
                            (
                                ...
                                'date' => '2020-12-30',
                                'sales_amount' => 146,
                                'commission_amount' => '131.4',
                                'invoice_id' => 458,
                                'commission_amount_2' => '14.6',
                            ),
                        ...
                        array
                            (
                                ...
                                'date' => '2020-12-30',
                                'sales_amount' => '211.6',
                                'commission_amount' => '190.44',
                                'invoice_id' => 458,
                                'commission_amount_2' => '21.16',
                            ),
                        ...
                        array
                            (
                                ...
                                'date' => '2020-12-31',
                                'sales_amount' => '435.8',
                                'commission_amount' => '392.22',
                                'invoice_id' => 458,
                                'commission_amount_2' => '43.58'
                            ),
                        ...
                        array
                            (
                                ...
                                'date' => '2020-12-31',
                                'sales_amount' => '210.5',
                                'commission_amount' => '189.45',
                                'invoice_id' => 458,
                                'commission_amount_2' => '21.05'
                            ),
                        ...
                        array
                            (
                                ...
                                'date' => '2021-01-02',
                                'sales_amount' => '164.8',
                                'commission_amount' => '148.32',
                                'invoice_id' => 458,
                                'commission_amount_2' => '16.48'
                            ),
                        ...
                        array
                            (
                                ...
                                'date' => '2021-01-03',
                                'sales_amount' => '88.4',
                                'commission_amount' => '79.56',
                                'invoice_id' => 458,
                                'commission_amount_2' => '8.84'
                            ),
                        ...
                        array
                            (
                                ...
                                'date' => '2021-01-03',
                                'sales_amount' => '96.4',
                                'commission_amount' => '86.76',
                                'invoice_id' => 458,
                                'commission_amount_2' => '9.64',
                            ),
                        ...
                        array
                            (
                                ...
                                'date' => '2021-01-03',
                                'sales_amount' => '154.1',
                                'commission_amount' => '138.69',
                                'invoice_id' => '458',
                                'commission_amount_2' => '15.41'
                            ),
                        ...
                        array
                            (
                                ...
                                'date' => '2021-01-03',
                                'sales_amount' => '154.7',
                                'commission_amount' => '139.23',
                                'invoice_id' => 458,
                                'commission_amount_2' => '15.47'
                            ),
                ...
                'client' => array
                    (
                        'userid' => 86,
                        'dryvarfoods_id' => 10036,
                        'crm_record' => 0,
                        'company' => 'Mochachos Umhlanga',
                        'vat' => '',
                        'phonenumber' => '0748060664',
                        'country' => 205,
                        'city' => 'Umhlanga',
                        'zip' => 4320,
                        'state' => 'KwaZulu-Natal',
                        'address' => '7 Lagoon Dr, Umhlanga, 4320, South Africa',
                        'website' => '',
                    ...
                    (
                        array
                            (
                                ...
                                'paymentmethod' => 'cash',
                                'date' => '2021-01-04',
                                'daterecorded' => '2021-01-04 00:00:00',
                                'note' => 'invoice payed',
                                'transactionid' => '',
                                'name' => '',
                                'description' =>'', 
    ...
    public function get_random_value(){
	...
	public function orders_ajax($client_id=''){
        
        $term = $this->input->post("term");
        
        $results = $this->invoices_model->get_orders_ajax($client_id, $term,$this->input->post());
	...
	public function get_order_details(){
        ...
        $results = $this->invoices_model->get_order_details($order_id);

        echo json_encode($results);
        exit;
    }
	
	public function get_order_items_ajax($client_id=''){
		$term = $this->input->post("term");
        
        $results = $this->invoices_model->get_order_items_ajax($client_id, $term,$this->input->post());
        
		if(count($results)>0){
		$count = 1;
        foreach($results as $value){
		if($value["order_type"] == 'manual'){
						$payout_amount = $value["subtotal"] + $value["restaurant_commision_fee"];
					}else{
						$payout_amount = $value["subtotal"] - $value["restaurant_commision_fee"];
					}
			
			echo '<tr class="orderItem" data-item-id="'.$count.'">
      <td class="dragger item_no ui-sortable-handle" align="center" width="5%">'.$count.'</td>
      <td align="left;" width="10%"><input rowno="'.$count.'" type="hidden" id="order_id'.$count.'" name="order_id[]" class="form-control order_select" value="'.$value["order_id"].'">'.$value["order_id"].'</td>
      <td align="left" width="10%"><input rowno="'.$count.'" type="hidden" id="date'.$count.'" name="date[]" class="form-control" value="'.$value["created_at"].'">'.$value["created_at"].'</td>
      <td align="left" width="10%"><input rowno="'.$count.'" type="hidden" id="payout_amount'.$count.'" name="payout_amount[]" class="form-control" value="'.number_format($value["subtotal"], 2, ".", "").'">R'.number_format($value["subtotal"], 2, ".", "").'</td>
      <td align="left" width="10%"><input rowno="'.$count.'" type="hidden" id="commission_amount'.$count.'" name="commission_amount[]" class="form-control" value="'.$value["restaurant_commision_fee"].'">R'.$value["restaurant_commision_fee"].'</td>
      <td align="left" width="10%"><input rowno="'.$count.'" type="hidden" id="sales_amount'.$count.'" name="sales_amount[]" class="form-control payout_amount" value="'.number_format($payout_amount, 2, ".", "").'" placeholder="Total Fee" readonly>R'.number_format($payout_amount, 2, ".", "").'</td>
      <td align="left" width="10%"><a rowno="'.$count.'" class="btn btn-danger btn-sm delete_item">Delete</a>
</tr>';
        $count++;
		}
		}
	...
	public function add_more(){
		...
		$data["count"] = $this->input->post("rowno");
		echo $this->load->view("admin/invoices/add_more", $data);
