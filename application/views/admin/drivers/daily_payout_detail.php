      ...
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">        
            ...
            <div class="col-md-12">
              <h3 class="padding-5 p_style"><?php echo $driver_details['firstname'];?>Payout Report
                            ...
                            $delivery_fee = 0;
                                ...
                                ?>
                    						<tr role="row">
                    							...
                    							<td>R<?php echo number_format($val["delivery_fee"], 2, ".", ",");?></td>
                              ...
                              <tr role="row">
                                ...
                                <td>R<?php echo number_format($delivery_fee, 2, ".", ",");?></td>
                                <td>R<?php echo number_format(0, 2, ".", ",");?></td> 
                              </tr>
                            <?php
                  				}else{ ?>
