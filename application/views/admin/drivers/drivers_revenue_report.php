    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">
             ...
             <div class="clearfix"></div>
              ...
              <div class="col-md-12">
                <h3 class="padding-5 p_style">Drivers Revenue Report  
          ...
          <div class="row">
            ...
            <table class="table table-hover  no-footer dtr-inline collapsed">
              ...
              <tbody>
					  ...
					  <?php 
					if(count($revenue)>0){
            $total_commision_earned = 0;
  					foreach($revenue as $val){ 
              $total_commision_earned +=$val["total_comission_earned"];
              $total_tips_earned +=$val["total_tips_paid"];

              if($val["order_type"] == 'auto'){  
                $label = '&nbsp;<span class = "label label-success">Auto</span>';
              }else{
                $label = '&nbsp;<span class = "label label-primary">Manual</span>';
              }

              ?>
  					  <tr role="row">
    						<td><?php echo $val["driver_id"];?></td>
                <td><?php echo $val["dryvarfoods_id"];?><?php echo $label; ?></td>
                ...
                <td>
                    <a href="<?php echo AURL;?>clients/orders_detail/<?php echo $val["dryvarfoods_id"]; ?>"class="btn btn-default btn-icon">
                        <i class="fa fa-eye"></i>
                    </a>
                </td>
  					  </tr> 
              ...
              <tr role="row">
                ...
                <td>R<?php echo number_format($total_commision_earned, 2, ".", ",");?></td>
                <td>R<?php echo number_format($total_tips_earned, 2, ".", ",");?></td> 
              </tr>
  				<?php } else{ ?>
					<tr>
            <td colspan="5"><p class="text-danger">No Records Found</p></td>
          </tr>
					<?php } ?>
        ...
        <div class="pull-right">
          <h5 style="color:#637381;font-size:16px;margin-bottom:0px" class="selected_date">
...
//Date range as a button
    $('#daterange-btn').daterangepicker(
      ...
      function (start, end, text_label="") {
        ...
        $.ajax({
                type:'POST',
                url:'<?php echo base_url();?>admin/drivers/drivers_revenue_report_ajax',
