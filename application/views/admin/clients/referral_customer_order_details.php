          ...
          <div class="panel-body">
            ...
            <div class="row mbot15">
              ...
              <div class="col-md-3 col-xs-6 border-right" style="border-bottom: 2px solid #31f300;">
                <h3 class="bold"><?php echo date("F j, Y, g:i a", strtotime($customer['datecreated'])); ?></h3>
              ...
              <div class="col-md-3 col-xs-6 border-right" style="border-bottom: 2px solid #ff9900;">
                <h3 class="bold"><?php echo round($customer['total_amount']/$customer['total_orders'],2);?> R</h3>
              ...
              <div class="row mbot15">
                <div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-6">
                  <div class="top_stats_wrapper hrm-minheight85">
                     ...
                     <p class="text-uppercase mtop5 hrm-minheight35"><i class="hidden-sm glyphicon glyphicon-edit"></i> Total Revenue </p>
                ...
                <div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-6">
                   <div class="top_stats_wrapper hrm-minheight85">
                       ...
                       <p class="text-uppercase mtop5 hrm-minheight35"><i class="hidden-sm glyphicon glyphicon-edit"></i> Completed Orders Revenue          </p>
                          <span class="pull-right bold no-mtop hrm-fontsize24" id="completedcount"><?php echo ($orders_count_completed); ?> R</span>
                       </a>
                       <div class="clearfix"></div>
                       <div class="progress no-margin progress-bar-mini">
                ...
                <div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-6">
                   <div class="top_stats_wrapper hrm-minheight85">
                       ...
                       <p class="text-uppercase mtop5 hrm-minheight35"><i class="hidden-sm glyphicon glyphicon-envelope"></i> Pending Orders Revenue          </p>
                ...
                <div class="panel-body padding-10" >
                  ...
                  <div class="text-center padding-5">
                    ...
                    <div class="alert alert-warning noorders" role="alert" style="display:none;">
                      0ops! No orders found against custmer.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-12">
              <div class="panel_s contracts-expiring">
                <div class="panel-body padding-10" >
                  <div id="containerTimeline2"></div>
                  <div class="col-md-12">
                    <div class="row mbot15">
                      
                      <div class="quick-stats-invoices col-xs-12 col-md-2 col-sm-4">
                        <div class="top_stats_wrapper hrm-minheight85">
                          <a style="color:#434348;" class="text-default mbot15">
                            <p class="text-uppercase mtop5 hrm-minheight35" style="text-align:center;border-bottom: 2px solid #cfcfcf;">REWARDS CODE</p>
                            <span class="no-mtop hrm-fontsize24"> ECR</span>
                          </a>
                          <div class="clearfix"></div>
                    ...
                    <div class="quick-stats-invoices col-xs-12 col-md-5 col-sm-4">
                        <div class="top_stats_wrapper hrm-minheight85">
                            <a style="color:#434348;" class="mbot15">
                              <p class="highcharts-title" style="text-align:center;border-bottom: 2px solid #cfcfcf;">
                                LOYALTY CREDIT
                              </p>
                                <span class="pull-left bold no-mtop hrm-fontsize24" id="pendingcount">R <?php if($loyality_available == ''){ echo 0; }else{echo number_format(round($loyality_available,2));} ?><br><span class="label label-info">Available</span>
                                </span>
                                <span class="pull-right bold no-mtop hrm-fontsize24" id="pendingcount">R <?php if($loyality_used == ''){ echo 0; }else{echo number_format(round($loyality_used,2));} ?> <br><span class="label label-danger">Used</span>
                                </span>
                             </a>
                             <div class="clearfix"></div>
                          </div>
                    ...
                    <div class="quick-stats-invoices col-xs-12 col-md-5 col-sm-4">
                        <div class="top_stats_wrapper hrm-minheight85">
                            <a style="color:#434348;" class="mbot15">
                            <p id="rewards_model" class="highcharts-title" style="text-align:center;border-bottom: 2px solid #cfcfcf; cursor:pointer;">REWARDS
                            </p>
                            <span class="pull-left bold no-mtop hrm-fontsize24" id="pendingcount"> R <?php if($reward_available == ''){ echo 0; }else{echo number_format(round($reward_available,2));} ?><br><span class="label label-info">Available</span>
                            </span>
                            <span class="pull-right bold no-mtop hrm-fontsize24" id="pendingcount"> R <?php if($reward_used == ''){ echo 0; }else{echo number_format(round($reward_used,2));} ?><br><span class="label label-danger">Used</span>
                            </span>
                            </a>
                             <div class="clearfix"></div>
                            </div>
...
<div class="modeldesign-main modal fade preview-model" id="deal_proposal_model" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modeldesign-inner">
    ...
    <div class="model-body">
      ...
      <h3 class="padding-5"><?php echo ucfirst($customer)?> <b>Reward Detail</b></h3>
      <!--<hr class="hr-panel-heading-dashboard">-->
      <div class="text-center padding-5">
        <div class="row">
            ...
            <table class="table table-hover  no-footer dtr-inline collapsed orderstable" >
              <thead>
                <tr role="row" style="background:#f6f8fa; border-top: 1px solid #f0f0f0!important;border-left: 0;border-right: 1px solid #f0f0f0;">
                  ...
                  <th style="min-width: 60px;font-weight: bold;">Status</th>
                  <!--<th style="min-width: 120px;font-weight: bold;">Time Lapse</th>-->
                  <th style="min-width: 60px;font-weight: bold;">Reward Point</th>
                  <th style="min-width: 60px;font-weight: bold;">Loyalty Point</th>
                  <th style="min-width: 60px;font-weight: bold;">Total Amout</th>
                  <th style="min-width: 60px;font-weight: bold;">Driver</th>
...
<!-- <script>
  ...
  var data = '<?php echo json_encode($timeline); ?>';
...
$(document).ready(function() {
    ...
    function get_rewards_data(){
        ...
        $.ajax({ 
            url : "<?php echo admin_url(); ?>clients/orders_reward_history_ajax/"+contact,
            type: "POST",
            data : "",
            ...
            { 
                ...
                Highcharts.chart('containerTimeline2', {
                      chart: {
                          type: 'column'
                      },
                      title: {
