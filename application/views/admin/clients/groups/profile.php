      ...
      <div class="horizontal-scrollable-tabs">
         ...
         <div class="horizontal-tabs">
            <ul class="nav nav-tabs profile-tabs row customer-profile-tabs nav-tabs-horizontal" role="tablist">
               ...
               <?php } ?>
               <li role="presentation">
                  <a href="#banking_details" aria-controls="banking_details" role="tab" data-toggle="tab">
                  <?php echo _l( 'Banking Details'); ?>
                  </a>
               </li>
               <?php hooks()->do_action('after_customer_billing_and_shipping_tab', isset($client) ? $client : false); ?>
            </ul>
         ...
         <div role="tabpanel" class="tab-pane<?php if(!$this->input->get('tab')){echo ' active';}; ?>" id="contact_info">
            <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  <?php $value=( isset($client) ? $client->dryvarfoods_id : 0); ?>
                  <?php $attrs = (isset($client) ? array() : array('autofocus'=>true)); ?>
                  <?php echo render_input( 'dryvarfoods_id', 'Dryvar Foods ID',$value,'text',$attrs); ?>


                  <?php $value=( isset($client) ? $client->commission : 0); ?>
                  <?php $attrs = (isset($client) ? array() : array('autofocus'=>true)); ?>
                  <?php echo render_input( 'commission', 'Commission %',$value,'text',$attrs); ?>
                  ...
                  <?php }
                     ...
                     if(is_admin() || get_option('staff_members_create_inline_customer_groups') == '1'){
                      echo render_select_with_input_group('groups_in[]',$groups,array('id','name'),'customer_groups',$selected,'<a href="#" data-toggle="modal" data-target="#customer_group_modal"><i class="fa fa-plus"></i></a><span style="font-size: large; font-weight: 800;"> / </span><a href="'.admin_url('clients/groups').'" target="_blank"><i class="fa fa-tasks"></i></a>',array('multiple'=>true,'data-actions-box'=>true),array(),'','',false);
                      } else {
               ...
               <div class="col-md-6">
				...
				<?php /*?>  <?php $value=( isset($client) ? $client->email : ''); ?>
                  <?php echo render_input( 'Email Address', 'email',$value); ?><?php */?>  
               ...
               <div class="col-md-12">
                  <div class="row">
                     <div class="col-md-12">
                        ...
                        <?php $value=( isset($client) ? $client->account_title : ''); ?>
                        <?php echo render_input( 'account_title', 'Account Title',$value); ?>
                        <?php $value=( isset($client) ? $client->account_no : ''); ?>
                        <?php echo render_input( 'account_no', 'Account No',$value); ?>
                        <?php $value=( isset($client) ? $client->account_description : ''); ?>
                        <?php echo render_textarea( 'account_description', 'Account Description',$value); ?>
