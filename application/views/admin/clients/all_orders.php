        ...
        <div class="panel_s">  
          <div class="panel-body" style="overflow-x: scroll;">
             ...
             <div class="clearfix"></div>
              <div class="row12">
              <div class=" col-md-12">
                <h3 class="padding-5 p_style">Dryvarfoods Orders Report  <span class="pull-right"><a href="<?php echo base_url();?>admin/clients/export_csv" target="_blank" class="btn btn-default buttons-collection btn-default-dt-options" type="button" id="csv_download" ><span>CSV DOWNLOAD</span></a></h4>
              </div>
              </div>
              <hr class="hr_style" />
              ...
              <div class="col-md-12 col-xs-12 bold p_style" style=""><h3> Filter Orders    <div  class="pull-right" style="float:right"><small class="primary" style="color:darkgreen">Showing 25 of <span id="record_count"  ><?php echo $total_count?></span></small></div></h3> </div>
              <div class="clearfix"></div>
              ...
              <div class="row">
                <div class="col-md-12 col-xs-12" style="">
                  <div class=" col-md-3 col-xs-6">
                    ...
                    <select class="js-example-data-ajax form-control order_type select_filters" id="order_type">
          ...
          <div class="row">
            ...
            <table class="table table-hover  no-footer dtr-inline collapsed" >
              <thead>
                <tr role="row" style="background:#f6f8fa; border-top: 1px solid #f0f0f0!important;border-left: 0; height:50px; border-right: 1px solid #f0f0f0;">
                  <th style="min-width: 30px;font-weight: bold;">S.NO</th>
                  <th style="min-width: 80px;font-weight: bold;">Order ID</th>
           ...
           ?>
                  <tr role="row">
                    ...
                    <td><?php echo ($value['customer_name']==" " || $value['customer_name']==NULL || $value['customer_name']=="" || empty($value['customer_name'])) ?  "<span style=''>N/A</span>" : ucfirst($value['customer_name'])  ; ?></td>
                    ...
                    <td><?php echo '<b>ZAR </b>'.$value['total_amont']; ?></td>
                    <td><?php echo ($value['driver_name']==" ") ? "<span>N/A</span>" : $value['driver_name']; ?></td>
                    <td>
                    <?php echo date("F j, Y, g:i a", strtotime($value['dated']));?>
                    </td>
