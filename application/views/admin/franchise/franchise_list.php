...
<?php //var_dump($arr_all_franchise); exit;?>
<style type="text/css">
  .hr_style {
    margin-top: 10px;
    border: 0.5px solid;
        ...
        <div class="panel_s">
          <div class="panel-body" style="">
             ...
             <div class="clearfix"></div>
              ...
              <div class="col-md-12">
                <h3 class=" p_style">Franchise List <div class="pull-right">
					  <a href="<?php echo base_url();?>admin/franchise/new_franchise" class="btn btn-info"  name="" id="" >Add Franchise</a>
					</div></h3></div>
             <!-- <hr class="hr_style" />
              ...
              <div class="clearfix"></div>
              <hr class="hr_style">
			  <form id="" method="post" action="https://crm.dryvarfoods.com/admin/franchise">
                ...
                <div class="col-md-12 col-xs-12" style="">
                 ...
                 <!-- <div class='col-sm-4'>
                  ...
                  <div class=" col-md-4 col-xs-6">
                    ...
                    <input class="form-control select_filters" type="text" name="firstname" id="firstname" value="<?php echo $this->input->post("firstname") ?>" placeholder="Search By Name">
                  </div>
                  
                    <div class=" col-md-4 col-xs-6">
                  
                    <label class=""><strong>Email </strong></label>
					<input class="form-control select_filters" type="text" name="email" id="email" value="<?php echo $this->input->post("email") ?>" placeholder="Search By Email">
                    
                  </div>
                  
                   <div class=" col-md-4 col-xs-6">
                   <label class=""><strong>. </strong></label>
					  <input class="btn btn-info" type="submit" name="" id="" value="Search"style="margin-top:25px;">
                       <input class="btn btn-danger" type="submit" name="Reset" id="" value="Reset"style="margin-top:25px;">
					</div>
                </div>
              </div>
            ...
            <table class="table table-hover  no-footer dtr-inline collapsed" >
              <thead>
                <tr role="row" style="background:#f6f8fa; border-top: 1px solid #f0f0f0!important;border-left: 0;border-right: 1px solid #f0f0f0;">
                  ...
                  <th style="min-width: 30px;font-weight: bold;">Franchiser ID</th>
              ...
              <tbody id="drivers_list">
                  ...
                  <?php foreach ($arr_all_franchise as $key => $value) {  ?>
                  
                  <tr role="row" style="height: 50px;">
                    <td><?php echo $key+1; ?></td>
                    <td><a  href="https://crm.dryvarfoods.com/admin/franchise/edit_franchise/<?php echo $value['staffid']; ?>"> <?php echo $value['staffid']; ?></a></td>
                   ...
                   <td>
                    ...
                    <td><a href="https://crm.dryvarfoods.com/admin/franchise/edit_franchise/<?php echo $value['staffid']; ?>" class="btn btn-primary fa fa-eye"></a></td>
                  </tr>
                  <?php } ?>
