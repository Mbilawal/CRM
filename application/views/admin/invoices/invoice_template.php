            ...
            <div class="row">
			   ...
			   <div class="col-md-6">
                    <div class="form-group" app-field-wrapper="date">
						...
						<div class="input-group date"><input type="text" id="date" name="date" class="form-control datepicker" value="<?php if($_GET["date_from"]){ echo $_GET["date_from"]; }?>" autocomplete="off"><div class="input-group-addon">
               ...
               <div class="col-md-6">
                    <div class="form-group" app-field-wrapper="date">
					    <label for="date" class="control-label">Invoice Due Date</label>
						<div class="input-group date"><input type="text" id="duedate" name="duedate" class="form-control datepicker" value="<?php if($_GET["date_to"]){ echo $_GET["date_to"]; }?>" autocomplete="off"><div class="input-group-addon">
						 <i class="fa fa-calendar calendar-icon"></i>
		                 </div>
				        </div>
					</div>               
...
<div class="row">
	...
	<div class="col-md-12">
      <div class="table-responsive">
         <table id="order_table" class="table items items-preview invoice-items-preview" data-type="invoice">
            <thead>
			   <?php if(isset($_GET["order_type"]) && $_GET["order_type"]=="manual"){ ?>
			    <tr>
                  <th align="center">#</th>
            ...
            <tbody class="order_items_container">
              <tr class="orderItem lastone" data-item-id="1">
                <td colspan="7"></td>
			  </tr>
            </tbody>
         </table>
   ...
   <div class="col-md-7 col-md-offset-5">
      <table class="table text-right">
		...
		<tbody>
            <tr id="subtotal">
              <td><span class="bold" style="font-weight: bold;" >Amount Due</span>
			           <input type="hidden" name="payout_amount_field" id="payout_amount_field" value="0">

                 <input type="hidden" name="filter_date_to" id="filter_date_to" value="<?php if($_GET["date_to"]){ echo $_GET["date_to"]; } ?>">
                 <input type="hidden" name="filter_date_from" id="filter_date_from" value="<?php if($_GET["date_from"]){ echo $_GET["date_from"]; }?>">
                 <input type="hidden" name="filter_order_type" id="filter_order_type" value="<?php if($_GET["order_type"]){ echo $_GET["order_type"]; }?>">
              </td>
              <td class="total_payout_amount">
				        0.00 R
              </td>
            </tr>
            <tr>
              <td><span class="bold" style="font-weight: bold;" >Amount Paid (R)</span></td>
              <td class="total_amount_paid">
		            <input type="number" name="amount_paid_field" id="amount_paid_field" value="0">
              </td>
            </tr>
	          <tr>
              <td><span class="bold" style="font-weight: bold;" >Total Outstanding</span><input type="hidden" name="total_amount_field" id="total_amount_field" value="0"></td>
              <td class="total">
		            0.00 R
              </td>
            </tr>
		...
		<?php } else{ ?>
         <tbody>
            ...
            <tr>
	          ...
	          <tr>
              <td><span class="bold" style="font-weight: bold;" >Total</span><input type="hidden" name="total_amount_field" id="total_amount_field" value="0"></td>
              <td class="total">
		            R0.00
              </td>
            </tr>
            ...
            <div class="btn-bottom-toolbar text-right">
              ...
              <div class="btn-group dropup">
                ...
                <ul class="dropdown-menu dropdown-menu-right width200">
                  ...
                  <li>
                      <a href="#" class="invoice-form-submit save-and-download transaction-submit">
                        Save And Download
                      </a>
                  </li>
                <?php } ?>
