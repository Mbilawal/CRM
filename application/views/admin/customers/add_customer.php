          ...
          <div class="panel-body">
            <div>
              <div class="tab-content">
                <h4 class="customer-profile-group-heading">Add New Customer</h4>
                <div class="row">
                  <form action="https://crm.dryvarfoods.com/admin/general_customers/signup_process" class="client-form" autocomplete="off" method="post" accept-charset="utf-8" novalidate="novalidate">
